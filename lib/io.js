...
rtc.sendOffers = function() {
  ...
  console.log("THESE ARE THE FUCKING PEERS " + rtc.connections);
...
rtc.createPeerConnection = function(id) {
  console.log("THIS IS NOT MY FUCKING ID: " + id);
  var pc = rtc.peerConnections[id] = new PeerConnection(rtc.SERVER, function(candidate, moreToFollow) {
    console.log("CREATED A NEW PEERCONNECTION IN ARRAY WITH ID OF " + id);
    if (candidate) {
